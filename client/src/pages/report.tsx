    ...
    <nav className="sticky top-0 z-50 border-b bg-background/95 backdrop-blur">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-6 py-3">
        ...
        <div className="flex items-center gap-4">
          ...
          <ThemeToggle />
          <Button variant="outline" onClick={async () => { await logout(); navigate("/"); }} data-testid="button-logout" className="gap-2">
      ...
      <div className="mx-auto max-w-5xl px-6 py-8" id="report-content">
        ...
        <div className="relative">
          <div className="absolute -top-8 right-0 flex items-center gap-1.5 bg-green-50 dark:bg-green-950/30 border border-green-500 dark:border-green-600 rounded-md px-2 py-1 shadow-sm print:hidden">
            ...
            <span className="text-xs font-semibold text-green-700 dark:text-green-400">Data Validated</span>
          </div>
